(function(){
  var CALCULATOR_ENABLED = true;
  var API_BASE_URL = 'https://ai-manager-nuvemshop.onrender.com';
  // ⚙️ Número do WhatsApp para cotação de medidas especiais
  var WHATSAPP_NUMBER = '5521964403083';
...
(function() {
  ...
  var isAlinePromoActiveOnStore = true;
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (isSearchPage) {
    ...
    if (query && query.trim() !== '') {
      ...
      const baseUrl = 'https://ai-manager-nuvemshop.onrender.com';
