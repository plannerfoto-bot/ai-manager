...
async function main() {
    ...
    const wf1_connections = {
        ...
        "Apenas order/updated?": {
            "main": [[{"node": "Tem Codigo Rastreio?","type": "main","index": 0}]]
        },
        "Tem Codigo Rastreio?": {
    ...
    const wf2_connections = {
        "17Track Webhook": {
            "main": [[{"node": "Status Entregue (40)?","type": "main","index": 0}]]
        },
        "Status Entregue (40)?": {
    ...
    console.log("SUCESSO: Webhooks configurados nas URLs:");
    console.log(`URL 1 (Ir na Nuvemshop): https://n8n.adminfotoplanner.com.br/webhook/nuvemshop-pedido-enviado`);
    console.log(`URL 2 (Ir no 17Track): https://n8n.adminfotoplanner.com.br/webhook/webhook-17track-entrega`);
}
